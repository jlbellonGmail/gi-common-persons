# Manual operativo de GI-COMMON-PERSONS
...
No modificar Core, Template ni verticales desde Persons sin autorización específica; resolver sus rutas reales, sin asumir unidad. No
...
No consultar tablas/stores/entidades privadas ni introducir dependencia a verticales.
Person y documentos son tenant-aware por Organization; no compartir entre tenants.
Esta decisión fue confirmada por el usuario el 2026-09-20.
El expediente runs/bootstrap-persons no constituye una unidad cerrada ni PR lista.
Sin remoto confirmado no simular start-work-unit ni inventar CI/aprobaciones.
La rama codex de bootstrap conserva preparación local; las unidades posteriores
usan las ramas y worktrees generados por el script oficial.
Los textos históricos del circuito no son evidencia de releases ni trabajo de Persons.

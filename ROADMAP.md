...
- [x] 09-integracion-core-v021 — integrar Core v0.2.1 publicado, identidad tenant-aware, link/unlink idempotente, auditoría, pruebas y PR lista para revisión humana.
- [x] 10-integracion-core-v030-tenants-v011 — actualizar Persons para Core v0.3.0 y Tenants v0.1.1, completar el modelo físico, persistencia, migraciones, contratos públicos, seguridad y evidencia de integración.

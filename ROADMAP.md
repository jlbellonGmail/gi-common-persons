...
- [-] 10-integracion-core-v030-tenants-v011 — actualizar Persons para Core v0.3.0 y Tenants v0.1.1, completar el modelo físico, persistencia, migraciones, contratos públicos, seguridad y evidencia de integración.
